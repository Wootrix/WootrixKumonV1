...
public class CommentActivity extends BaseActivity implements OnClickListener, IAsyncCaller
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.comment_popup_screen);
	...
	private void initViews()
	{
		...
		mTxtVwHeaderTitle.setText(getString(R.string.header_comment));

		mListVwCommentsList = (ListView) findViewById(R.id.comment_screen_listviw);
		mEdtTxtComment = (EditText) findViewById(R.id.comment_screen_comment_edtTxt);
		mBtnSendComment = (Button) findViewById(R.id.comment_screen_send_comment_btn);
		mTxtVwNoComments = (TextView) findViewById(R.id.comment_screen_no_comments_txt);
	...
	public void onClick(View v)
	{
		switch ( v.getId() )
		{
			case R.id.header_back_btn_imgVw :
				Intent commentCount = new Intent();
				commentCount.putExtra("count", mCommetsList.size() + "");
				setResult(RESULT_OK, commentCount);
				finish();
				break;
			case R.id.comment_screen_send_comment_btn :
				validateComment();
				break;
