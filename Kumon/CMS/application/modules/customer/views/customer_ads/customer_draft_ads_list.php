...
<script>
    ...
    function LanguageData(val,catId,langId) {
        window.location.href="<?php echo base_url();?>index.php/customerDraftedarticle?catagory="+catId+"&lang="+val;
    }
  ...
  /* SORT CATAGORY DATA*/
   ...
   function CatagoryData(val,catId,langId) {
        var rowId = val;//      
        window.location.href="<?php echo base_url();?>index.php/customerDraftedarticle?catagory="+val+"&lang="+langId;
...
<nav class="clearfix">
    <div class="fix-container clearfix">
        <ul>
            ...
            <li class="active"><a href="customerDraftedarticle"><?php echo $this->lang->line('Draft') ?> <span class="yellow"><?php echo $all_drafted_advertise; ?></span></a></li>
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/customerDraftedarticle" method="POST">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="catagory_form" action="<?php echo $this->config->base_url() ?>index.php/customerDraftedarticle" method="POST">
                ...
                <tr> <?php
                    ...
                    <td><a class="view-btn" href="<?php echo $this->config->base_url(); ?>index.php/view_custo_advertise?rowId=<?php echo $value['id']; ?>">View</a></td>
                        ...
                        <td><?php if ($value['status'] == '0') { ?>
                            ...
                            <?php } elseif($value['status'] == '3') { ?>
                                <a class="delete-bttn" href="#" onclick="SHIFTDELETE(<?php echo $value['id']; ?>, '<?php echo "delete"; ?>');">Permanent delete</a>
                                <a class="aprove-btn" href="#" onclick="RESTORE(<?php echo $value['id']; ?>, '<?php echo "Restore"; ?>');">restore</a>
