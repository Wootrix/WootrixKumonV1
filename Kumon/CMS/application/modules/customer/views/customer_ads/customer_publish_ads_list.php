...
<script>
   ...
   /* GET LANGUAGE ID AND FETCH LANGUAGE DATA*/
    ...
    function LanguageData(val,catId,langId) {
        window.location.href="<?php echo base_url();?>index.php/customerPublishedarticle?catagory="+catId+"&lang="+val;
    }
  ...
  /* SORT CATAGORY DATA*/
   ...
   function CatagoryData(val,catId,langId) {
        var rowId = val;//      
        window.location.href="<?php echo base_url();?>index.php/customerPublishedarticle?catagory="+val+"&lang="+langId;
...
<nav class="clearfix">
    <div class="fix-container clearfix">
        <ul>
            ...
            <li class="active"><a href="customerPublishedarticle"><?php echo $this->lang->line('Published') ?> <span class="green"><?php echo $all_publish_advertise; ?></span></a></li>
...
<!--    <div class="upper_bar clearfix filter-bar">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/customerPublishedarticle" method="POST">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="catagory_form" action="<?php echo $this->config->base_url() ?>index.php/customerPublishedarticle" method="POST">
                        <select class="choose-lang" onChange="CatagoryData(this.value,'<?php echo $_GET['catagory'] ?>','<?php echo $_GET['lang'] ?>');" name="catagory" id="catagory">
                            <option value="" name="">Select Magazine</option>
    ...
    <div class="category-list">
        ...
        <script>
    $(document).ready(function () {
        $('#publishAds').dataTable({"bPaginate": false});
    });
        </script>
            <table id="publishAds" border="0" cellpadding="0" cellspacing="0">
                <thead>
                <tr>
                    ...
                    <td><a class="view-btn" href="<?php echo $this->config->base_url(); ?>index.php/view_custo_advertise?rowId=<?php echo $value['id']; ?>">View</a></td>
                        ...
                        <td><?php if ($value['status'] == '0') { ?>
                            ...
                            <?php } elseif($value['status'] == '3') { ?>
                                ...
                                <a class="restore-btn" href="#" onclick="RESTORE(<?php echo $value['id']; ?>, '<?php echo "Restore"; ?>');">restore</a>
