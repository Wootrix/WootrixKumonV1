    ...
    <div class="add-article">
        ...
        <div class="add-article-form show_form">
            ...
            <div class="input-box clearfix">
                ...
                <input type="text" id="dt1" placeholder="<?php echo $this->lang->line('Enter_Date') ?>" name="datefrom"
                       readonly="true"></div>

            <div class="input-box clearfix"><label><?php echo $this->lang->line('Publish_Date_To') ?></label>
                <input type="text" id="dt2" placeholder="<?php echo $this->lang->line('Enter_Date') ?>" name="dateto"
                       readonly="true"></div>
            ...
            <div class="input-box">
                <div class="input-container clearfix">
                    ...
                    <?php if ($auto_publish): ?>
                        <input type="submit" value="Publicar" name="real_publish"/>
                    <?php endif; ?>

                    <input type="submit" value="Salvar em Rascunho" name="save"/>

                    <?php if (!$auto_publish): ?>
                        <input type="submit" value="Enviar para Review" name="publish"/>
                    <?php endif; ?>
        ...
        <script>
            $(document).ready(function () {//alert('y');
                ...
                //Add PDF;
                $('#media_type_p').click(function () {//alert('hey');
                    $('#media_type_s').removeAttr('checked');
                    $('#video_div').show();
                    $('#video_div_thumb').show();
                    $('#embed_div').show();
