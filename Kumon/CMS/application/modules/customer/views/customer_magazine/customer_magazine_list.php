...
<!--        <a class="add-new" href="<?php echo $this->config->base_url(); ?>index.php/addarticle">Add New</a>-->
        <a class="add-new" href="<?php echo base_url()?>index.php/addCustomerArticle"><?php echo $this->lang->line('Manually') ?></a>
        <a class="add-new" href="<?php echo base_url()?>index.php/addCustomerArticle?request=1"><?php echo $this->lang->line('Via_URL') ?></a>
                    ...
                    if ($data_result != "") {
                        foreach ($data_result as $value) {
                            ...
                            <li>
                                ...
                                <h4>(<?php echo $value['article_count']." "; ?><?php echo $this->lang->line('to_web') ?>)</h4>
                                <h5><?php echo date("d-m-y", strtotime($value['publish_date_from'])) . ' to ' . date("d-m-y", strtotime($value['publish_date_to'])); ?></h5>
