...
<script>
    ...
    function LanguageData(val,catId,langId,rowId,catlang) {
        window.location.href="<?php echo base_url();?>index.php/customer_publisharticle?catagory="+catId+"&lang="+val+"&rowId="+rowId+"&cat_lang=" +catlang;
    }

  /* SORT CATAGORY DATA*/
  
   function CatagoryData(val,catId,langId,rowId1,catlang) {   
        window.location.href="<?php echo base_url();?>index.php/customer_publisharticle?catagory="+val+"&lang="+langId+"&rowId="+rowId1+"&cat_lang=" +catlang;
    ...
    function CatLangData(val,catId,catlang,langId,rowId1) {
        ...
        //var rowId = val;//      
        window.location.href = "<?php echo base_url(); ?>index.php/customer_publisharticle?catagory="+catId+"&lang="+langId+"&rowId="+rowId1+"&cat_lang=" +val;
        //$('#catagory_form').submit();
    }
...
<nav class="clearfix">
    <div class="fix-container clearfix"><?php //echo"<pre>"; print_r($_REQUEST); ?>
        <ul>
            ...
            <li class="active"><a href="customer_publisharticle?rowId=<?php echo$_REQUEST['rowId']; ?>"><?php echo $this->lang->line('Published') ?> <span class="green"><?php echo $magazine_publish_article; ?></span></a></li>
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/customer_publisharticle?rowId=<?php echo $magazine_id;?>" method="POST">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <?php //echo"<pre>";  print_r($magazine_id) ;  ?>
                    <form id="sort_catagory" action="<?php echo $this->config->base_url() ?>index.php/customer_publisharticle?rowId=<?php echo $magazine_id;?>" method="POST">
