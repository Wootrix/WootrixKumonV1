        ...
        <div class="container clearfix">
            <div class="news-container clearfix">
                ...
                <div class="span6">
                    <div class="grid1 border-right border-bottom">
                        ...
                        <a target="_blank" href="<?php echo $getMagazineAdv['advertisement']['link']; ?>" target="_blank" onclick='remoteaddr(<?php echo $getMagazineAdv['advertisement']['adsid']; ?>);'>
                            <?php } ?>
                        <figure>
                            <?php 
                ...
                //echo $getMagazineAdv['advertisement']['embed_video'];
                                ...
                                <div class="video-overlay">
                                            <a target="_blank" href="<?php echo $this->config->base_url(); ?>assets/Advertise/<?php echo $getMagazineAdv['advertisement']['cover_image']; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/website_images/pause-icon.png"></a>
                                </div>
            ...
            <?php }}else{ ?>
                        ...
                        <img src="<?php echo base_url().$getMagazineAdv['advertisement']['embed_thumb']; ?>" />
                            ...
                            <div class="video-overlay">
                              <a href="<?php echo $match[1]; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/website_images/pause-icon.png"></a>
                            </div>
                        </a>
                        <?php }?>
                    </div>
                    ...
                    <div class="grid2 border-right border-top clearfix">
                        <a target="_blank" href="<?php if($getMagazineAdv['articles'][0]['article_link']!='' && $getMagazineAdv['articles'][0]['article_link']!='0'){echo $getMagazineAdv['articles'][0]['article_link'];}else{echo $this->config->base_url(); ?>index.php/wootrix-article-detail?source=<?php echo $getMagazineAdv['articles'][0]['source']; ?>&articleId=<?php echo $getMagazineAdv['articles'][0]['id']; ?>&magazineId=<?php echo $_GET['magazineId'];} ?>">
                        <figure>
                             ...
                             <?php 
                                ...
                                <?php }else if($getMagazineAdv['articles'][0]['media_type']=='1'){
                                    ...
                                    if($getMagazineAdv['articles'][0]['embed_video']!=''){ 
                                                ...
                                                <a target="_blank" href="<?php echo $match[1] ?>" ><img src="<?php echo base_url(); ?>images/website_images/pause-icon.png"></a>
                                            </div>
                                            <img src="<?php echo $this->config->base_url() . $getMagazineAdv['articles'][0]['embed_video_thumb']; ?>" class="videoThumbnal videoThumbnal3_1" />
                                            <?php }else{
...
<!--                                <video>
                                ...
                                <div class="video-overlay video-overlay3_1">
                                            <a target="_blank" href="<?php echo $video1; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/website_images/pause-icon.png"></a>
                                </div>
...
<!--                            <img src="<?php echo $this->config->base_url(); ?>assets/Article/<?php echo $getMagazineAdv['articles'][0]['image']; ?>" alt="" />-->
                        ...
                        <section>
                            ...
                            <?php }if($getMagazineAdv['articles'][0]['article_link']!=''){
                                ...
                                ?>
                            <a target="_blank" href="<?php echo $getMagazineAdv['articles'][0]['article_link']; ?>" class="article-website"><?php echo ($link_name[0])."..."; ?></a>
                            <?php } ?>
                        </div>
                            <a target="_blank" href="<?php if($getMagazineAdv['articles'][0]['article_link']!='' && $getMagazineAdv['articles'][0]['article_link']!='0'){echo $getMagazineAdv['articles'][0]['article_link'];}else{echo $this->config->base_url(); ?>index.php/wootrix-article-detail?source=<?php echo $getMagazineAdv['articles'][0]['source']; ?>&articleId=<?php echo $getMagazineAdv['articles'][0]['id']; ?>&magazineId=<?php echo $_GET['magazineId'];} ?>">
                            <p><?php echo substr($getMagazineAdv['articles'][0]['description_without_html'],0,220).""; ?></p>
                ...
                <div class="span3">
                    <div class="grid3 border-right">
                        <section>
                            <a target="_blank" href="<?php if($getMagazineAdv['articles'][1]['article_link']!='' && $getMagazineAdv['articles'][1]['article_link']!='0'){echo $getMagazineAdv['articles'][1]['article_link'];}else{echo $this->config->base_url(); ?>index.php/wootrix-article-detail?source=<?php echo $getMagazineAdv['articles'][1]['source']; ?>&articleId=<?php echo $getMagazineAdv['articles'][1]['id']; ?>&magazineId=<?php echo $_GET['magazineId'];} ?>">
                        ...
                        <div class="article-details">
                            ...
                            <?php }if($getMagazineAdv['articles'][1]['article_link']!=''){
                                $link = str_replace(array('http://', 'https://', 'www.'), '', $getMagazineAdv['articles'][1]['article_link']);
                                        $link_name = explode('.', $link);
                                ?>
                            <a target="_blank" href="<?php echo $getMagazineAdv['articles'][1]['article_link']; ?>" class="article-website"><?php echo ($link_name[0])."..."; ?></a>
                            <?php } ?>
                        </div>
                        <a target="_blank" href="<?php if($getMagazineAdv['articles'][1]['article_link']!='' && $getMagazineAdv['articles'][1]['article_link']!='0'){echo $getMagazineAdv['articles'][1]['article_link'];}else{echo $this->config->base_url(); ?>index.php/wootrix-article-detail?source=<?php echo $getMagazineAdv['articles'][1]['source']; ?>&articleId=<?php echo $getMagazineAdv['articles'][1]['id']; ?>&magazineId=<?php echo $_GET['magazineId'];} ?>">
                            <p><?php echo substr($getMagazineAdv['articles'][1]['description_without_html'],0,170).""; ?></p>
                    ...
                    <div class="grid4 border-right border-top">
                        <a target="_blank" href="<?php if($getMagazineAdv['articles'][2]['article_link']!='' && $getMagazineAdv['articles'][2]['article_link']!='0'){echo $getMagazineAdv['articles'][2]['article_link'];}else{echo $this->config->base_url(); ?>index.php/wootrix-article-detail?source=<?php echo $getMagazineAdv['articles'][2]['source']; ?>&articleId=<?php echo $getMagazineAdv['articles'][2]['id']; ?>&magazineId=<?php echo $_GET['magazineId'];} ?>">
                        <figure>
                            ...
                            <?php }elseif($getMagazineAdv['articles'][2]['media_type'] == "1"){
                                ...
                                if($getMagazineAdv['articles'][2]['embed_video']!=''){ 
                                            ...
                                            <img src="<?php echo $this->config->base_url() . $getMagazineAdv['articles'][2]['embed_video_thumb']; ?>" class="videoThumbnal videoThumbnal3_2" />
                                            <?php }else{
...
<!--                                <video>
                                ...
                                <div class="video-overlay video-overlay3_2">
                                            <a target="_blank" href="<?php echo $video3; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/website_images/pause-icon.png"></a>
                                </div>
                        ...
                        <div class="article-details">
                            ...
                            <?php }if($getMagazineAdv['articles'][2]['article_link']!=''){
                                $link = str_replace(array('http://', 'https://', 'www.'), '', $getMagazineAdv['articles'][2]['article_link']);
                                        $link_name = explode('.', $link);
                                ?>
                            <a target="_blank" href="<?php echo $getMagazineAdv['articles'][2]['article_link']; ?>" class="article-website"><?php echo ($link_name[0])."..."; ?></a>
                            <?php } ?>
                        </div>
                        
                            <p><?php echo substr($getMagazineAdv['articles'][2]['description_without_html'],0,150).".."; ?></p>
                    ...
                    <div class="grid3 border-bottom">
                        ...
                        <?php }elseif($getMagazineAdv['articles'][3]['media_type'] == "1"){
                            ...
                            if($getMagazineAdv['articles'][3]['embed_video']!=''){ 
                                            ...
                                            <img src="<?php echo $this->config->base_url() . $getMagazineAdv['articles'][3]['embed_video_thumb']; ?>" class="videoThumbnal" />
                                            <?php }else{
...
<!--                                <video>
                                ...
                                <div class="video-overlay">
                                            <a target="_blank" href="<?php echo $video4; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/website_images/pause-icon.png"></a>
                                </div>
                        ...
                        <div class="image-overlay">
                          <h4><?php echo substr($getMagazineAdv['articles'][3]['title'],0,30); ?></h4>
                            ...
                            echo date("d/m/Y", strtotime($getMagazineAdv['articles'][3]['publish_date']));
                                ...
                                <?php }if($getMagazineAdv['articles'][3]['article_link']!='' && $getMagazineAdv['articles'][3]['article_link']!='0'){
                                    $link = str_replace(array('http://', 'https://', 'www.'), '', $getMagazineAdv['articles'][3]['article_link']);
                                        $link_name = explode('.', $link);
                                    ?>
                            <a target="_blank" class="article-website" href="<?php echo $getMagazineAdv['articles'][3]['article_link']; ?>"><?php echo ($link_name[0])."..."; ?></a>
                                <?php } ?>
                        </div><p><?php echo substr($getMagazineAdv['articles'][3]['description_without_html'],0,150); ?>
                            <?php if ($getMagazineAdv['articles'][3]['article_link'] != '') { ?>
                                    <a href="<?php echo $getMagazineAdv['articles'][3]['article_link']; ?>" target="_blank"><?php echo $this->lang->line("more"); ?>..</a>
                                <?php }else{ ?>
                        <a target="_blank"  href="<?php echo $this->config->base_url(); ?>index.php/wootrix-article-detail?source=<?php echo $getMagazineAdv['articles'][3]['source']; ?>&articleId=<?php echo $getMagazineAdv['articles'][3]['id']; ?>&magazineId=<?php echo $_GET['magazineId']; ?>">
                    ...
                    <div class="grid4">
                        <a target="_blank" href="<?php if($getMagazineAdv['articles'][4]['article_link']!='' && $getMagazineAdv['articles'][4]['article_link']!='0'){echo $getMagazineAdv['articles'][4]['article_link'];}else{echo $this->config->base_url(); ?>index.php/wootrix-article-detail?source=<?php echo $getMagazineAdv['articles'][4]['source']; ?>&articleId=<?php echo $getMagazineAdv['articles'][4]['id']; ?>&magazineId=<?php echo $_GET['magazineId'];} ?>">
                        <figure>
                            ...
                            <?php }elseif($getMagazineAdv['articles'][4]['media_type'] == "1"){
                                ...
                                if($getMagazineAdv['articles'][4]['embed_video']!=''){ 
                                            ...
                                            <img src="<?php echo $this->config->base_url() . $getMagazineAdv['articles'][4]['embed_video_thumb']; ?>" class="videoThumbnal videoThumbnal3_4" />
                                            <?php }else{
...
<!--                                <video>
                                ...
                                <div class="video-overlay video-overlay3_4">
                                            <a target="_blank" href="<?php echo $video5; ?>" target="_blank"><img src="<?php echo base_url(); ?>images/website_images/pause-icon.png"></a>
                                </div>
<img src="<?php echo $this->config->base_url().'assets/Article/thumbs/'.$getMagazineAdv['articles'][4]['video_path'];?>demo.jpeg" class="videoThumbnal videoThumbnal3_4" />
                        ...
                        <div class="article-details">
                            ...
                            <?php }if($getMagazineAdv['articles'][4]['article_link']!='' && $getMagazineAdv['articles'][4]['article_link']!='0'){
                                $link = str_replace(array('http://', 'https://', 'www.'), '', $getMagazineAdv['articles'][4]['article_link']);
                                        $link_name = explode('.', $link);
                                ?>
                            <a target="_blank" href="<?php echo $getMagazineAdv['articles'][4]['article_link']; ?>" class="article-website"><?php echo ($link_name[0])."..."; ?></a>
                            <?php } ?>
                        </div>
                        
                        <p><?php echo substr($getMagazineAdv['articles'][4]['description_without_html'],0,150); ?> </p>
