            ...
            <div class="span6 right">
				...
				<!-- One -->
					<section id="one" class="wrapper style1 special">
						<div class="inner">
							<header class="major">
								<h2>A maneira inteligênte de se encontrar e distribuir conhecimento.</h2>
							</header>
						</div>
					</section>
				...
				<!-- Three -->
					<section id="three" class="wrapper style3 special">
						<div class="inner">
							<header class="major">
								<h2>O caminho mais curto para se manter informado!</h2>
							...
							<ul class="features">
								<li class="icon fa-filter">
									...
									<p> Dentre os tópicos disponíveis selecione os de seu interesse, bem como defina os idiomas (Português, Inglês, Espanhol) em que deseja receber conteúdo. </p>
								</li>
								...
								<li class="icon fa-users">
									...
									<p>Ao associar suas contas no painel de controle, você informa ao sistema quem você é, possibilitando logar com as redes sociais compatíveis sem perder suas configurações.</p>
								</li>
							</ul>
						</div>
					</section>
...
<script>
    j(document).ready(function () {
		...
		s1.async=true;
		s1.src='https://embed.tawk.to/57646f67b57c050020953609/default';
		s1.charset='UTF-8';
