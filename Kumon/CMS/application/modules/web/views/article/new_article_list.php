...
<script>
    ...
    function LanguageData(val, catId, langId) {
        window.location.href = "<?php echo base_url(); ?>index.php/getnewarticlelist?catagory=" + catId + "&lang=" + val;
    }
    ...
    function CatagoryData(val, catId, langId) {
        var rowId = val;//      
        window.location.href = "<?php echo base_url(); ?>index.php/getnewarticlelist?catagory=" + val + "&lang=" + langId;
...
<!--        <a class="add-new" href="<?php echo $this->config->base_url(); ?>index.php/addarticle">Add New</a>-->
        <a class="add-new" href="<?php echo $this->config->base_url(); ?>index.php/addarticle"><?php echo $this->lang->line('Manually') ?></a>
        <a class="add-new" href="<?php echo $this->config->base_url(); ?>index.php/addarticle?request=1"><?php echo $this->lang->line('Manually') ?></a>
...
<nav class="clearfix">
    <div class="fix-container clearfix">
        <ul>
            ...
            <li class="active"><a href="getnewarticlelist"><?php echo $this->lang->line('New') ?> <span class="yellow"><?php echo $all_new_article; ?></span></a></li>
            ...
            <div class="search-box">
                <div class="language-filter clearfix">
                    <div class="select-container">
                        ...
                        <form id="catagory_form" action="<?php echo $this->config->base_url() ?>index.php/getnewarticlelist" method="POST">
        ...
        <div class="search-bar right-align-box">
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/getnewarticlelist" method="POST">
...
<?php echo validation_errors(); ?></div>
        ...
        <script>
    $(document).ready(function () {
        $('#newArticle').dataTable({"bPaginate": false,"bSort": false});
    });
        </script>
            <table id="newArticle" border="0" cellpadding="0" cellspacing="0">
                <thead>
                <tr>
...
-->                            <td><?php if($value['article_language']=='1'){ echo"English"; }
                            ...
                            <td>
                        <spam class="pending-btn"><?php echo $this->lang->line("New"); ?></spam>
                        </td>
