...
<script>
 ...
 /* GET LANGUAGE ID AND FETCH LANGUAGE DATA*/
    ...
    function LanguageData(val,catId,langId) {
        window.location.href="<?php echo base_url();?>index.php/getdeletedarticlelist?catagory="+catId+"&lang="+val;
    }
  ...
  /* SORT CATAGORY DATA*/
   ...
   function CatagoryData(val,catId,langId) {
        var rowId = val;//      
        window.location.href="<?php echo base_url();?>index.php/getdeletedarticlelist?catagory="+val+"&lang="+langId;
...
<nav class="clearfix">
    <div class="fix-container clearfix">
       <ul>
            ...
            <li class="active"><a href="getdeletedarticlelist"><?php echo $this->lang->line('Deleted') ?> <span class="red"><?php echo $all_deleted_article; ?></span></a></li>            
        </ul>
    </div>
</nav>
...
<!--        <div class="search-bar">
            <div class="search-box">
                <div class="language-filter clearfix">
                    <div class="select-container">
                        ...
                        <form id="catagory_form" action="<?php echo $this->config->base_url() ?>index.php/getdeletedarticlelist" method="POST">
        ...
        <div class="search-bar right-align-box">
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/getdeletedarticlelist" method="POST">
    ...
    <div class="category-list">
        ...
        <script>
    $(document).ready(function () {
        $('#deletedArticles').dataTable({"bPaginate": false,"bSort": false});
    });
        </script>
            <table id="deletedArticles" border="0" cellpadding="0" cellspacing="0">
                <thead>
                <tr>
...
-->                            <td><?php if($value['article_language']=='1'){ echo"English"; }
                           ...
                           <td>
                            ...
                            <?php } elseif ($value['status'] == '2') { ?>                                
                                ...
                                <a class="delete-bttn" href="#" onclick="DELETE(<?php echo $value['id']; ?>, '<?php echo "delete"; ?>');">DELETE</a> 
                            <?php } else { ?>
                                <!--a class="rejected-btn btn-block" href="#" onclick="RESTORE(<?php echo $value['id']; ?>, '<?php echo "delete"; ?>');">RESTORE</a-->
...
<div class="layer-bg">
    <div class="popup-container clearfix">
        ...
        <h4><?php echo $this->lang->line('ADMIN_INFORMATION') ?></h4>
