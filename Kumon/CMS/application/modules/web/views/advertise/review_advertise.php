...
<script>
    ...
    function LanguageData(val,catId,langId) {
        window.location.href="<?php echo base_url();?>index.php/reviewadvertiselisting?catagory="+catId+"&lang="+val;
    }

/* SORT Magazine DATA*/
  
   function MagazineData(val,catId,langId) {
        var rowId = val;//      
        window.location.href="<?php echo base_url();?>index.php/reviewadvertiselisting?catagory="+val+"&lang="+langId;
...
<nav class="clearfix">
    <div class="fix-container clearfix">
        <ul>
            ...
            <li class="active"><a href="reviewadvertiselisting"><?php echo $this->lang->line('Review') ?> <span class="dark-green"><?php echo $all_review_advertise; ?></span></a></li>
        </ul>
    </div>
</nav>
...
<!--    <div class="upper_bar clearfix filter-bar">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/reviewadvertiselisting" method="POST">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="catagory_form" action="<?php echo $this->config->base_url() ?>index.php/reviewadvertiselisting" method="POST">
                        <select class="choose-lang" onChange="MagazineData(this.value,'<?php echo $_GET['catagory'] ?>','<?php echo $_GET['lang'] ?>');" name="catagory" id="catagory">
    ...
    <div class="category-list">
        ...
        <script>
    $(document).ready(function () {
        $('#openArticle').dataTable({"bPaginate": false});
    });
        </script>
...
<!--                                     <img class="upper-image" src ="<?php echo $this->config->base_url() . 'images/'."video-thumb.png"; ?>">-->
                            ...
                            <spam class="aprove-btn"><?php echo $this->lang->line('Select_Language') ?></spam>
                        <?php } elseif ($value['is_approved'] == '2') { ?>
                            <spam class="rejected-btn">Rejected</spam>
                        <?php } else { ?>
                            <spam class="pending-btn" href="#">Pending </spam>
                        <?php } ?></a></td>
                        <td><a class="view-btn" href="<?php echo $this->config->base_url(); ?>index.php/approvedeclinearticle?rowId=<?php echo $value['id']; ?>">Review</a></td>
                        </tr>
                    <?php } ?>
            </tbody>
            </table>
...
<!--            <script>
    $(function() {
        $("#datefrom").datepicker({yearRange: "1900:3000", dateFormat: 'yy-mm-dd', changeMonth: true, changeYear: true, minDate: 'today', inline: true});
            ...
            <tr><td><?php echo $this->lang->line('Publish_Date_From') ?></td><td><input type="text" id ="dt1" placeholder="enter date" name="datefrom" readonly="true"></td></tr>
<!--            <script>
                $(function() {
            ...
            <tr><td><?php echo $this->lang->line('Publish_Date_To') ?></td><td><input type="text" id ="dt2" placeholder="enter date" name="dateto" readonly="true"></td></tr>
