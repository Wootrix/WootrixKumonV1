...
<script>
    ...
    function LanguageData(val,catId,langId) {
        window.location.href="<?php echo base_url();?>index.php/draftadvertiselisting?catagory="+catId+"&lang="+val;
    }
  ...
  /* SORT CATAGORY DATA*/
   ...
   function CatagoryData(val,catId,langId) {
        var rowId = val;//      
        window.location.href="<?php echo base_url();?>index.php/draftadvertiselisting?catagory="+val+"&lang="+langId;
...
<nav class="clearfix">
    <div class="fix-container clearfix">
        <ul>
            ...
            <li class="active"><a href="draftadvertiselisting"><?php echo $this->lang->line('Draft') ?> <span class="yellow"><?php echo $all_drafted_advertise; ?></span></a></li>
            <li><a href="deletedadvertiselisting"><?php echo $this->lang->line('Deleted') ?> <span class="red"><?php echo $all_deleted_advertise; ?></span></a></li>
...
<!--    <div class="upper_bar clearfix filter-bar">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/draftadvertiselisting" method="POST">
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="catagory_form" action="<?php echo $this->config->base_url() ?>index.php/draftadvertiselisting" method="POST">
    ...
    <div class="category-list">
        ...
        <script>
    $(document).ready(function () {
        $('#draftedAd').dataTable({"bPaginate": false});
    });
        </script>
            <table border="0" cellpadding="0" cellspacing="0" id="draftedAd">
                <thead>
                <tr>
                ...
                <tr> <?php
                        ...
                        foreach ($data_result as $value) { $sourceId=$value['source']; ?> 
                            <td>
...
<!--                                     <img class="upper-image" src ="<?php echo $this->config->base_url() . 'images/'."video-thumb.png"; ?>">-->
                            ...
                            <td><?php
                                ...
                                ?></td>
                            <td>
                            <spam class="pending-btn" href="#">Pending </spam></a>
                            </td>
                        ...
                        <td><?php if ($value['status'] == '0') { ?>
                                <a class="review" href="#" id="<?php echo $value['id']; ?>">Publish</a>
                                <a class="delete-bttn" href="<?php echo $this->config->base_url(); ?>index.php/advertisedelete?rowId=<?php echo $value['id']; ?>&source=<?php echo $sourceId; ?>">delete</a>
                            <a class="edit-icon" href="<?php echo $this->config->base_url(); ?>index.php/editadvertise?rowId=<?php echo $value['id']; ?>&source=<?php echo $sourceId; ?>">Edit</a>
                            <?php } ?>
                            </tr>
                        <?php
                    }
...
<!--            <script>
    $(function() {
        $("#datefrom").datepicker({yearRange: "1900:3000", dateFormat: 'yy-mm-dd', changeMonth: true, changeYear: true, minDate: 'today', inline: true});
            ...
            <div class="input-box clearfix"><label><?php echo $this->lang->line('Publish_Date_From') ?></label><input type="text" id ="dt1" placeholder="enter date" name="datefrom" readonly="true"></div>
<!--            <script>
                $(function() {
            ...
            <div class="input-box clearfix"><label><?php echo $this->lang->line('Publish_Date_To') ?></label><input type="text" id ="dt2" placeholder="enter date" name="dateto" readonly="true"></div>

            <div class="input-box clearfix"><label><?php echo $this->lang->line('Display_time') ?></label><input type="text" id ="time" placeholder="enter time" name="time"></div>
