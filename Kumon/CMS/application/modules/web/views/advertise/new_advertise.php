...
<nav class="clearfix">
    <div class="fix-container clearfix">
        <ul>
            ...
            <li class="active"><a href="newadvertiselisting"><?php echo $this->lang->line('New') ?> <span class="yellow"><?php echo $all_new_advertise; ?></span></a></li>
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container">
                    ...
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/newadvertiselisting" method="POST">
                        <select class="choose-lang" onChange="LanguageData(this.value);" name="lang" id="lang">
                            ...
                            foreach ($language_result as $state) {
                                ...
                                //echo '<option value="' . $state['id'] . 'if(' . $state['id'] == . $selected_language . ')echo selected=selected">' . $state['language'] . '</option>';
                            }
                            ?>
                        </select>
                    </form>
...
<!--                                     <img class="upper-image" src ="<?php echo $this->config->base_url() . 'images/'."video-thumb.png"; ?>">-->
                        ...
                        <td><a class="view-btn" href="<?php echo $this->config->base_url(); ?>index.php/viewadvertise?rowId=<?php echo $value['id']; ?>">View</a></td>
                        <td><?php if ($value['status'] == '0') { ?>
                                <a class="review" href="#">Publish</a>
                            <?php } ?>
                            <a class="delete-bttn" href="#" onclick="DELETE(<?php echo $value['id']; ?>, '<?php echo "delete"; ?>');">delete</a>
                            <a class="edit-icon" href="<?php echo $this->config->base_url(); ?>index.php/editadvertise?rowId=<?php echo $value['id']; ?>">Edit</a></td>
                        </tr>
                        <?php
                    }
                }
