    ...
    <div class="login-container clearfix">
        <?php //echo"<pre>"; print_r($this->session); ?>
         ...
         <?php 
           ...
           echo form_open($this->config->base_url().'index.php/login_check',$attributes);?>   
        ...
        <div class="input-container">
            <label>Username :</label>            
                <input id="email"  type="text" name="username" value="<?php echo $_COOKIE['remember_me_wootrix']; ?>">                			
        </div>
        ...
        <div class="input-container clearfix">
        <input type="checkbox" name="remembermewoo" value="1" <?php if(isset($_COOKIE['remember_me_wootrix'])) { ?>checked="checked" <?php } ?>/>
            <span><?php echo $this->lang->line('Remember_me'); ?></span>           
            <input type="submit" value="Login" name ="login" />
        </div>
        <div class="input-container clearfix">
            <a href="admin_forgot_password">Lost your password ?</a>
        </div>   
