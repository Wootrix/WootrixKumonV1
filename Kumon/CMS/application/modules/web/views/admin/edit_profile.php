...
<body>
    ...
    <div class="add-new-customer clearfix">
        ...
        echo form_open_multipart($this->config->base_url() . 'index.php/admineditprofile', $attributes);
        ?>  
        ...
        <div style="color: red"><p><?php echo $msg;  echo $this->session->flashdata("msg");?>   </p>
            ...
            <div class="input-field-cont">
                ...
                <input id="work_phone"  type="text" name="work_phone" value="<?php echo$data_result['work_phone'];  ?>" maxlength="15">
            </div>
            
            <div class="input-field-cont">
                <label><?php echo $this->lang->line('Mobile') ?></label>            
                <input id="mobile"  type="text" name="mobile" value="<?php echo$data_result['mobile'];  ?>" maxlength="15">
            </div>
    ...
    <?php echo form_close(); ?> 
        ...
        <div class="login-credential clearfix">
           ...
           <?php $attributes_form = array('name' => 'change_password_new_form', 'id' => 'change_password_new_form', 'class' => 'form-horizontal');
           echo form_open_multipart($this->config->base_url() . 'index.php/adminchangePassword', $attributes_form);
           ?>  
        <?php //echo"<pre>"; print_r($data_result); ?>
        <div style="color: red"><!--p><?php //echo $msg;  echo $this->session->flashdata("msg");?>   </p-->
            <?php echo validation_errors(); ?></div>
            ...
            <div class="input-field-cont">
                ...
                <input id="password_confirm"  type="password" name="password_confirm" value="" placeholder="<?php echo $this->lang->line('confirm_password') ?>">           
            </div>
             <div class="input-container clearfix"> 
            <input type="submit" value="save" name ="save" />
            <input type="hidden" value="<?php echo$data_result['id'];  ?>" name ="customer_id" />
        ...
        <script>
         ...
         /* CHANGE PASSWORD*/
          ...
          $(function() {
                ...
                // Setup form validation on the #register-form element
                $("#change_password_new_form").validate({
                    // Specify the validation rules
                    rules: {
                        password:"required",
