...
<script>
    ...
    function LanguageData(val, catId, langId, rowId, catlang) {
        window.location.href = "<?php echo base_url();?>index.php/magazinearticlelist?catagory=" + catId + "&lang=" + val + "&rowId=" + rowId + "&cat_lang=" + catlang;
    }

    /* SORT CATAGORY DATA*/

    function CatagoryData(val, catId, langId, rowId1, catlang) {
        window.location.href = "<?php echo base_url();?>index.php/magazinearticlelist?catagory=" + val + "&lang=" + langId + "&rowId=" + rowId1 + "&cat_lang=" + catlang;
    ...
    function CatLangData(val, catId, catlang, langId, rowId1) {
        ...
        //var rowId = val;//      
        window.location.href = "<?php echo base_url(); ?>index.php/magazinearticlelist?catagory=" + catId + "&lang=" + langId + "&rowId=" + rowId1 + "&cat_lang=" + val;
        //$('#catagory_form').submit();
    }
...
<div class="subheader">
    <div class="fix-container clearfix">
        <h4><?php echo $magazine_title['title'] . " " . $this->lang->line('Magazine'); ?></h4>
    </div>
</div>
...
<nav class="clearfix">
    <div class="fix-container clearfix"><?php //echo"<pre>"; print_r($_REQUEST); ?>
        <ul>
            <li class="active"><a
                        href="magazinearticlelist?rowId=<?php echo $_REQUEST['rowId']; ?>"><?php echo $this->lang->line('All') ?>
                    <span class="blue"><?php echo $all_article; ?></span></a></li>
            <li>
                <a href="magazinepublishedarticlelist?rowId=<?php echo $_REQUEST['rowId']; ?>"><?php echo $this->lang->line('Published') ?>
                    <span class="green"><?php echo $magazine_publish_article; ?></span></a></li>
            <li>
                <a href="magazinereviewarticlelist?rowId=<?php echo $_REQUEST['rowId']; ?>"><?php echo $this->lang->line('Review') ?>
                    <span class="yellow"><?php echo $magazine_review_article; ?></span></a></li>
            <li>
                <a href="magazinedeletedarticlelist?rowId=<?php echo $_REQUEST['rowId']; ?>"><?php echo $this->lang->line('Deleted') ?>
        ...
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container"> 
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/magazinearticlelist" method="GET">
...
<!--    --><?php //echo "<pre>"; print_r($data_result); exit; ?>
    ...
    <div class="category-list">
        <div class="table-container">
            ...
            if ($data_result != "") { ?>
                ...
                <script>
                    $(document).ready(function () {
                        $('#allMag').dataTable({"bPaginate": false, "bSort": false});
                    });
                </script>
                <table id="allMag" class="adjust-table" border="0" cellpadding="0" cellspacing="0">
                    <thead>
                    <tr>
                        <th>Ordem</th>
                    ...
                    <tr>
                        ...
                        <td><span class="commentNotification"><em><?php echo $value['comments_count']; ?></em></span>
                        </td>
                        ...
                        <td><?php if ($value['status'] == '1') { ?>
                                ...
                                <a class="aprove-btn"
                                   href="<?php echo $this->config->base_url(); ?>index.php/reviewmagazinearticle?magId=<?php echo $_GET['rowId']; ?>&rowId=<?php echo $value['id']; ?>&source=<?php echo $value['source']; ?>">Review</a>
                            ...
                            <a class="edit-icon"
                               href="<?php echo $this->config->base_url(); ?>index.php/editMagazinearticle?rowId=<?php echo $_GET['rowId']; ?>&artId=<?php echo $value['id']; ?>&source=<?php echo $value['source'] ?>">Edit</a>
                        </td>
                    ...
                    <?php } else { ?>
                        <a class="delete-bttn"
                           ...
                           href="<?php echo $this->config->base_url(); ?>index.php/deletemagzineads?val=<?php echo $value['id']; ?>&source=<?php echo $value['source'] ?>&rowId=<?php echo $_GET['rowId'] ?>">delete</a>
                        <a class="edit-icon"
                           href="<?php echo $this->config->base_url(); ?>index.php/editMagazinearticle?rowId=<?php echo $_GET['rowId']; ?>&artId=<?php echo $value['id']; ?>&source=<?php echo $value['source'] ?>">Edit</a></td>
                    <?php } ?>
                    </tr>
                    <?php
                    }
    ...
    <div class="popup-container clearfix">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="datefrom" placeholder="enter date" name="datefrom"></td>
            </tr>
            <script>
                $(function () {
                    $("#dateto").datepicker({
            ...
            <tr>
                ...
                <td><input type="text" id="dateto" placeholder="enter date" name="dateto"></td>
            </tr>
