...
<script>
    ...
    function LanguageData(val,catId,langId,rowId) {
        window.location.href="<?php echo base_url();?>index.php/magazinedeletedarticlelist?catagory="+catId+"&lang="+val+"&rowId="+rowId;
    }

  /* SORT CATAGORY DATA*/
  
   function CatagoryData(val,catId,langId,rowId1) {   
        window.location.href="<?php echo base_url();?>index.php/magazinedeletedarticlelist?catagory="+val+"&lang="+langId+"&rowId="+rowId1;
...
<nav class="clearfix">
    <div class="fix-container clearfix">
        <ul>
            ...
            <li class="active"><a href="magazinedeletedarticlelist?rowId=<?php echo$_REQUEST['rowId']; ?>"><?php echo $this->lang->line('Deleted') ?> <span class="red"><?php echo $magazine_deleted_article; ?></span></a></li>
...
<!--        <div class="upper_bar clearfix filter-bar">
        <div class="search-bar right-align-box">    
            <div class="language-filter clearfix">
                <div class="select-container"> 
                    <form id="languge_form" action="<?php echo $this->config->base_url() ?>index.php/magazinedeletedarticlelist" method="GET">
    ...
    <div class="category-list">
        ...
        <script>
    $(document).ready(function () {
        $('#deletedArticle').dataTable({"bPaginate": false,"bSort": false});
    });
        </script>
            <table id="deletedArticle" border="0" cellpadding="0" cellspacing="0">
                <thead>
                <tr>
